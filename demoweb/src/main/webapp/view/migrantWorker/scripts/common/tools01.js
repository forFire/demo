...
define(['jquery', 'config', 'cnzz', 'md5'], function($, config, _czc, md5) {
  var Tools01, tools01;
  Tools01 = (function() {
    function Tools01() {
      this.$ = $;
    ...
    Tools01.prototype.showMsg = function(text) {
      var $error;
      $error = $('#error-tips');
    ...
    Tools01.prototype.getUrlParam = function(name) {
      var r, reg;
      reg = new RegExp("(^|&)" + name + "=([^&]*)(&|$)");
    ...
    Tools01.prototype.getUserId = function() {
    ...
    Tools01.prototype.getUserPhone = function() {
    ...
    Tools01.prototype.isAndroid = function() {
      return /android/i.test(this.ua);
    };

    Tools01.prototype.isIOS = function() {
      return /(iPhone|iPad|iPod|iOS)/i.test(this.ua);
    };

    Tools01.prototype.isWeixin = function() {
      return this.ua.match(/MicroMessenger/i) === "micromessenger";
    };

    Tools01.prototype.inApp = function() {
      var in_app;
      in_app = 0;
    ...
    Tools01.prototype.setCookie = function(name, value) {
      var exp;
      exp = new Date();
 ...
 　　　　　 var $error;
  ...
  　　　　}
    ...
    Tools01.prototype.shareLog = function(shareType, eventType) {
      return $.ajax({
    ...
    Tools01.prototype.pv = function(options) {
      if (this.inApp()) {
    ...
    Tools01.prototype.action = function(options) {
      if (this.inApp()) {
    ...
    Tools01.prototype.openShare = function(){
      if(this.isAndroid()){
        try {
    ...
    Tools01.prototype.download = function(){
      window.location.href = 'https://apk.95155.com/xz.jsp?k=14';
    };

    Tools01.prototype.postToken = function(url,params,callback){
      var _p={
  			head:{
    ...
    Tools01.prototype.md5 = md5;

    return Tools01;

  })();
  return tools01 = new Tools01();
});
