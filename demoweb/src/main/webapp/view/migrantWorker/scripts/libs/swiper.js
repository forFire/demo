...
function() {
    ...
    var r = {
        ...
        trigger: function() {
            ...
            for (var a = i[0].split(" "), r = i[1], n = 0; n < a.length; n += 1) for (var o = 0; o < this.length; o += 1) {
                ...
                } catch(t) { (l = e.createEvent("Event")).initEvent(a[n], !0, !0),
                    l.detail = r
                }
    ...
    var u = {
        ...
        updateSlides: function() {
            ...
            if (void 0 !== s) {
                ...
                M = E / C,
                z = M - (e.slidesPerColumn * M - o), P = 0; P < o; P += 1) {
                    T = 0;
                    var k = n.eq(P);
                    ...
                    if ("none" !== k.css("display")) {
                        ...
                        c.push(T),
                        e.centeredSlides ? (w = w + T / 2 + y / 2 + b, 0 === y && 0 !== P && (w = w - s / 2 - b), 0 === P && (w = w - s / 2 - b), Math.abs(w) < .001 && (w = 0), x % e.slidesPerGroup == 0 && l.push(w), p.push(w)) : (x % e.slidesPerGroup == 0 && l.push(w), p.push(w), w = w + T + b),
    ...
    Y = {
        ...
        init: function() {
            ...
            if (t.el) {
                var i = s(t.el);
                0 !== i.length && (e.params.uniqueNavElements && "string" == typeof t.el && i.length > 1 && 1 === e.$el.find(t.el).length && (i = e.$el.find(t.el)), "bullets" === t.type && t.clickable && i.addClass(t.clickableClass), i.addClass(t.modifierClass + t.type), "bullets" === t.type && t.dynamicBullets && (i.addClass("" + t.modifierClass + t.type + "-dynamic"), e.pagination.dynamicBulletIndex = 0, t.dynamicMainBullets < 1 && (t.dynamicMainBullets = 1)), t.clickable && i.on("click", "." + t.bulletClass,
                function(t) {
                    t.preventDefault();
    ...
    q = {
        ...
        setTranslate: function(e, t) {
            ...
            if (Array.isArray(r)) for (var o = 0; o < r.length; o += 1) r[o] !== t && r[o] instanceof P && n(r[o]);
        ...
        setTransition: function(e, t) {
            ...
            if (Array.isArray(a)) for (i = 0; i < a.length; i += 1) a[i] !== t && a[i] instanceof P && r(a[i]);
